            ...
            <div class="flex flex-col justify-center">
             ...
             <div class="w-full px-4">
                <div class="form-control w-full">
                  ...
                  <input type="text" placeholder="Ex: paul.djossou@azohoue.com" class="input input-bordered w-full" />
                  <label class="label">
                    <!-- <span class="label-text-alt">Alt label</span> -->
                  </label>
                </div>
            ...
            <div class="flex flex-col justify-center">
                <div class="flex flex-col sm:flex-row  gap-x-4 px-4">
                    ...
                    <div class="form-control w-full ">
                     ...
                     <input type="text" placeholder="Ex: azohoue" class="input input-bordered w-full" />
                     <label class="label">
                       <!-- <span class="label-text-alt">Alt label</span> -->
                     </label>
                   </div>
                   ...
                   <div class="form-control w-full">
                     ...
                     <input type="text" placeholder="recrutement@azohoue.com" class="input input-bordered w-full" />
                     <label class="label">
                       <!-- <span class="label-text-alt">Alt label</span> -->
                     </label>
                   </div>
                ...
                <div class="w-full px-4">
                    <div class="form-control w-full">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="url" id="url" placeholder="www.azohoue.com" class="input input-bordered w-full rounded-l-none">
                        </div>
                        <label class="label">
                            <!-- <span class="label-text">Site web de l'entreprise</span> -->
                        </label>
                ...
                <div class="w-full px-4">
                    ...
                    <textarea type="text" placeholder="Ex: Nous sommes une entreprise basée dans le milieu de la tech..." class="input input-bordered w-full h-[200px] p-2 resize-none" />
                    <label class="label">
                        <!-- <span class="label-text-alt">Alt label</span> -->
                    </label>
                    </div>
