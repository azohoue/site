<section class="grid grid-cols-1 lg:grid-cols-2">
  <div class="w-full px-4 py-20 mx-auto bg-white xl:py-32 md:w-3/5 lg:w-4/5 xl:w-3/5">
    <h1 class="mb-4 -mt-3 text-2xl font-extrabold leading-snug tracking-tight text-left text-gray-900 md:text-4xl">Sign up to our product today for free</h1>
    <form class="mt-8 space-y-4">
      ...
      <input type="submit" class="w-full btn btn-primary btn-lg" value="Register" />
    </form>
    <div class="pt-6 mt-6 text-sm font-medium text-gray-700 border-t border-gray-200">
      Already have an account?
      <a href="/employers/auth/signin" class="text-purple-700 hover:text-purple-900">Sign Up</a>
    </div>
  </div>
