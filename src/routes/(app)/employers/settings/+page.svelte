<script lang="ts">
	...
	let preview: any, pHTML;
	const employer = data.employer;
	const organization = data.organization;
	const renderHTML = () => {
		preview.innerHTML = sanitizeHTML(marked(organization.description), {
			allowedTags: [
				'h1',
				'h2',
				'h3',
...
<div id="profile" class="py-10 px-4 sm:px-0 flex flex-col items-center gap-y-4 h-fit overflow-auto">
	<div id="user-profile" class="min-h-[360px] w-full sm:w-[60vw] flex flex-col gap-5">
		...
		<form
			...
			class="h-full w-full bg-white rounded-md border-[1px] border-[#A4A4A480] shadow-sm grid grid-rows-[1fr,72px]"
		>
	...
	<div id="company-profile" class="min-h-[360px] w-full sm:w-[60vw] flex flex-col gap-5">
		<div id="user-profile-header">
			...
			<p class="text-sm text-[#8A8FAC]">Veuillez saisir vos informations sur votre organization.</p>
		</div>
			...
			<div class="flex flex-col justify-center">
				<div class="flex flex-col sm:flex-row  gap-x-4 px-4">
					...
					<div class="form-control w-full">
						...
						<input
							...
							type="text"
							name="email-pro"
							placeholder="recrutement@azohoue.com"
							class="input input-bordered w-full"
						/>
						<label class="label">
							<!-- <span class="label-text-alt">Alt label</span> -->
				...
				<div class="w-full px-4">
					<div class="form-control w-full">
						...
						<div class="flex">
							<span
								class="flex items-center px-3 pointer-events-none text-base sm:text-sm rounded-l-md bg-gray-700 text-white"
								>https://</span
							>
							<input
				...
				<div class="w-full px-4">
					<div class="form-control w-full">
						...
						<input type="file" class="file-input w-full file-input-bordered" name="logo" />
						<label class="label">
							<!-- <span class="label-text-alt">Alt label</span> -->
						</label>
					</div>
				...
				<div class="w-full px-4">
					<div class="form-control w-full">
						...
						<div id="offer-description" class="flex flex-col gap-1">
							...
							>
							<div
								class="border-[1px] w-full h-[280px] rounded-md bg-white grid grid-rows-[48px,1fr] p-1"
							>
								<div
									class="border-b-[1px] flex gap-2 items-center justify-center sm:justify-start overflow-x-auto"
								>
									<div
									...
									<div
										class="h-10 w-10 flex justify-center items-center cursor-pointer"
										on:click={() => {
											organization.description += '<exemple@gmail.com> ';
											renderHTML();
										}}
									>
										<svg style="width:24px;height:24px" viewBox="0 0 24 24">
							...
							<div
								id="description"
								bind:this={preview}
								class="min-h-0 bg-white px-4 max-w-full break-words my-4"
							/>
						</div>
