...
>
	<div class="w-full sm:w-[60vw] flex flex-col gap-y-5">
		<div class="h-10 border-b-2 flex justify-between items-center">
			...
			>
				<!-- <span class="indicator-item badge indicator-start">0</span>  -->
				<svg
			...
			{#each jobs as job}
				...
				>
					...
					<div class="flex justify-between items-center">
						...
						<div>
							<button
								class="normal-case px-[12px] py-2 border-[1px] rounded-md text-red-400 hover:text-white hover:bg-red-400 border-[#F87171] transition-all"
								>Modifier</button
							>
						</div>
					</div>
